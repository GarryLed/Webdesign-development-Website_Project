...
function Logout() {
    ...
    if (loggedin == 1) {
        ...
        window.location.href = "/Webdesign-development-Website_Project/index.html";
    } else {
        window.location.href = "/Webdesign-development-Website_Project/login.html";
    }
}
...
function checkLoginStatus() {
    ...
    if (loggedin == 1) {
        ...
        element.setAttribute("href", "/Webdesign-development-Website_Project/login.html");
        var element = document.getElementById("userdetails");
